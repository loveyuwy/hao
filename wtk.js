...
class CaishowWidget extends DmYY {
  ...
  async updateScript() {
    const url = "https://raw.githubusercontent.com/loveyuwy/hao/refs/heads/main/wtk.js";
    const a = new Alert();
    try {
  ...
  async fetchData() {
    ...
    try {
        ...
        const reqW = new Request(weatherUrl);
        reqW.timeoutInterval = 8;
        
        const reqA = new Request(aqiUrl);
        reqA.timeoutInterval = 8;
